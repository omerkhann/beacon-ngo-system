-- Fresh database setup for Beacon NGO Management System - Using Fresh Name
USE master;
GO

-- Create new database with fresh name
CREATE DATABASE beacon_ngo;
GO
...
PRINT 'Database beacon_ngo created successfully with all tables!';
GO
